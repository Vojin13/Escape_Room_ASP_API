        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinimumPlayers = table.Column<short>(type: "smallint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseTokenId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuthTokens_AuthTokens_BaseTokenId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    SupportCode = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimeslotLocks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TimeslotLocks_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TimeslotLocks_Timeslots_TimeslotId",
                        column: x => x.TimeslotId,
                        principalTable: "Timeslots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TimeslotLocks_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 6, 27, 14, 37, 9, 481, DateTimeKind.Utc).AddTicks(2156), "Pending" },
                    { 2, new DateTime(2026, 6, 27, 14, 37, 9, 481, DateTimeKind.Utc).AddTicks(2160), "Confirmed" },
                    { 3, new DateTime(2026, 6, 27, 14, 37, 9, 481, DateTimeKind.Utc).AddTicks(2161), "Cancelled" },
                    { 4, new DateTime(2026, 6, 27, 14, 37, 9, 481, DateTimeKind.Utc).AddTicks(2162), "Completed" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_AuthTokens_BaseTokenId",
                table: "AuthTokens",
                column: "BaseTokenId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AuthTokens_TokenId",
                table: "AuthTokens",
                column: "TokenId",
                unique: true)
                .Annotation("Npgsql:IndexInclude", new[] { "InvalidatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeslotLocks_RoomId",
                table: "TimeslotLocks",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_TimeslotLocks_TimeslotId",
                table: "TimeslotLocks",
                column: "TimeslotId");

            migrationBuilder.CreateIndex(
                name: "IX_TimeslotLocks_UserId",
                table: "TimeslotLocks",
                column: "UserId");
